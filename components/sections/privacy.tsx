            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-1/2">
                        <h2 className="text-[48px] font-medium leading-[1.1] tracking-tight text-black mb-12 max-w-lg">
                    ...
                    <div className="lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        {cards.map((card) => (
                            <div
                                key={card.id}
                                className="group border border-black/[0.05] p-8 min-h-[280px] flex flex-col hover:border-black/10 transition-colors bg-white/50 backdrop-blur-sm"
                            >
                                <div className="flex items-center gap-2 mb-6">
                                    <span className="text-[10px] font-mono text-black/30">/ {card.id}</span>
                                    <span className="text-[10px] font-bold tracking-widest text-black/60 uppercase">{card.label}</span>
                                </div>
